...
const ALL_GAMES: GameEntry[] = [
  ...
  // ── Matematicas ──
  { id:"qm4",  subject:"math",     title:"Quiz de Matematicas", titleEn:"Math Quiz",             grade:4, available:false,                                      description:"Operaciones basicas y fracciones.",                  descriptionEn:"Basic operations and fractions.",                  difficulty:"Facil",   questions:6,  time:20 },
  { id:"qm5",  subject:"math",     title:"Quiz de Matematicas", titleEn:"Math Quiz",             grade:5, available:false,                                      description:"Decimales, porcentajes y geometria.",                descriptionEn:"Decimals, percentages and geometry.",              difficulty:"Medio",   questions:8,  time:25 },
  { id:"qm6",  subject:"math",     title:"Quiz de Matematicas", titleEn:"Math Quiz",             grade:6, available:false,                                      description:"Algebra basica y estadistica.",                      descriptionEn:"Basic algebra and statistics.",                    difficulty:"Dificil", questions:10, time:30 },
  ...
  { id:"qs4",  subject:"science",  title:"Quiz de Ciencias",    titleEn:"Science Quiz",          grade:4, available:false,                                      description:"Seres vivos, cuerpo humano y ambiente.",             descriptionEn:"Living things, human body and environment.",       difficulty:"Facil",   questions:6,  time:15 },
  { id:"qs5",  subject:"science",  title:"Quiz de Ciencias",    titleEn:"Science Quiz",          grade:5, available:false,                                      description:"Ecosistemas, materia y energia.",                    descriptionEn:"Ecosystems, matter and energy.",                   difficulty:"Medio",   questions:8,  time:20 },
  { id:"qs6",  subject:"science",  title:"Quiz de Ciencias",    titleEn:"Science Quiz",          grade:6, available:false,                                      description:"Fisica, quimica y ciencias de la tierra.",           descriptionEn:"Physics, chemistry and earth sciences.",           difficulty:"Dificil", questions:10, time:25 },
  ...
  { id:"qso4", subject:"social",   title:"Quiz de Sociales",    titleEn:"Social Studies Quiz",   grade:4, available:false,                                      description:"Historia dominicana, geografia y valores.",          descriptionEn:"Dominican history, geography and values.",         difficulty:"Facil",   questions:6,  time:15 },
  { id:"qso5", subject:"social",   title:"Quiz de Sociales",    titleEn:"Social Studies Quiz",   grade:5, available:false,                                      description:"Latinoamerica, economia y cultura.",                 descriptionEn:"Latin America, economy and culture.",              difficulty:"Medio",   questions:8,  time:20 },
  { id:"qso6", subject:"social",   title:"Quiz de Sociales",    titleEn:"Social Studies Quiz",   grade:6, available:false,                                      description:"Historia mundial y ciudadania global.",              descriptionEn:"World history and global citizenship.",            difficulty:"Dificil", questions:10, time:20 },
];
            ...
            return (
              <div key={subjectKey} className="mb-10">
                ...
                {GRADES.map(grade => {
                  ...
                  // ✅ FIX: saltar grados sin juegos para esta materia

...
export function Laberinto(){
  ...
  if(screen==="resultados"){
    ...
    return(
      <motion.div initial={{opacity:0}} animate={{opacity:1}} className="w-full min-h-screen flex flex-col items-center px-4 py-10 overflow-y-auto" style={{background:"linear-gradient(160deg,#080d1e 0%,#0d0a1a 100%)"}} style={{background:"linear-gradient(135deg,#06091a 0%,#12091a 50%,#06091a 100%)"}}>
        <div className="relative z-10 w-full max-w-lg">
          ...
          <motion.div initial={{opacity:0,scale:0.95}} animate={{opacity:1,scale:1}} transition={{delay:0.7}} className="rounded-2xl border-2 p-6 mb-6" style={{background:"linear-gradient(135deg,rgba(155,68,255,0.08),rgba(0,229,255,0.04))",borderColor:"rgba(155,68,255,0.3)"}}>
            ...
            <div className="flex justify-center gap-10">
              <div className="text-center"><div className="w-10 h-10 rounded-full flex items-center justify-center text-xl mx-auto mb-2" style={{background:"linear-gradient(135deg,#ffd700,#ff9800)",boxShadow:"0 0 20px rgba(255,215,0,0.7),0 0 40px rgba(255,215,0,0.2)"}}>🪙</div><div className="font-['Press_Start_2P'] text-2xl text-[#ff9800]">+{puntos}</div><div className="text-xs font-bold text-gray-500 mt-1 uppercase tracking-widest">Monedas</div></div>
              <div className="text-center"><div className="w-10 h-10 rounded-full flex items-center justify-center text-xl mx-auto mb-2" style={{background:"linear-gradient(135deg,#a78bfa,#7c3aed)",boxShadow:"0 0 20px rgba(167,139,250,0.7),0 0 40px rgba(167,139,250,0.2)"}}>⚡</div><div className="font-['Press_Start_2P'] text-2xl text-[#a78bfa]">+{Math.round(puntos*1.5)}</div><div className="text-xs font-bold text-gray-500 mt-1 uppercase tracking-widest">Experiencia</div></div>
            </div>
          </motion.div>
  ...
  if(screen==="config")return(
    <motion.div initial={{opacity:0,y:18}} animate={{opacity:1,y:0}} className="w-full max-w-xl mx-auto px-4 py-8">
      ...
      <div className="relative overflow-hidden rounded-2xl border-2 border-[#9b44ff]/30 bg-[#080d1e] p-6 mb-5" style={{boxShadow:"0 4px 28px rgba(155,68,255,0.1)"}}>
  ...
  return(
    <motion.div initial={{opacity:0}} animate={{opacity:1}} className="w-full min-h-screen flex flex-col relative overflow-hidden" style={{background:"linear-gradient(135deg,#06091a 0%,#12091a 50%,#06091a 100%)"}}>
      ...
      {/* TOPBAR */}
      <div className="relative z-10 flex items-center gap-2 px-3 md:px-4 py-2 border-b border-white/5" style={{background:"rgba(4,6,18,0.97)",backdropFilter:"blur(20px)",borderBottom:`1px solid rgba(155,68,255,0.2)`}}>

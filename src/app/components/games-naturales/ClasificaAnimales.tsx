...
export function ClasificaAnimales(){
  ...
  if(screen==="resultados"){
    ...
    return(
      <motion.div initial={{opacity:0}} animate={{opacity:1}} className="w-full min-h-screen flex flex-col items-center px-4 py-10 overflow-y-auto" style={{background:"linear-gradient(135deg,#06091a 0%,#1a0a06 50%,#06091a 100%)"}}>
  ...
  if(screen==="config")return(
    <motion.div initial={{opacity:0,y:18}} animate={{opacity:1,y:0}} className="w-full max-w-xl mx-auto px-4 py-8">
      ...
      <div className="relative overflow-hidden rounded-2xl border-2 border-[#ff9800]/30 bg-[#0f1425] p-6 mb-5" style={{boxShadow:"0 4px 28px rgba(255,152,0,0.1)"}}>
  ...
  return(
    <motion.div initial={{opacity:0}} animate={{opacity:1}} className="w-full min-h-screen flex flex-col relative overflow-hidden" style={{background:"linear-gradient(135deg,#06091a 0%,#1a0a06 50%,#06091a 100%)"}}>
      ...
      <div className="relative z-10 w-full h-1.5" style={{background:"rgba(255,255,255,0.04)"}}><div className="h-full transition-all duration-500" style={{width:`${(totalClasificados/Math.max(1,totalAnimales))*100}%`,background:"linear-gradient(90deg,#ff9800,#ffd700)",boxShadow:"0 0 10px rgba(255,152,0,0.6)"}}/></div>
